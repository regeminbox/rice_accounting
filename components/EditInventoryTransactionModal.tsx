...
const EditInventoryTransactionModal: React.FC<EditInventoryTransactionModalProps> = ({ transaction, product, onClose, onUpdate }) => {
  ...
  const handleDelete = async () => {
    if (!confirm('정말 이 입고 기록을 삭제하시겠습니까?\n재고도 함께 조정됩니다.')) {
      return;
    }
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg mx-4 overflow-hidden border border-slate-200">
        ...
        <div className="bg-gradient-to-br from-sky-500 to-blue-600 p-6 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold">입고 기록 수정</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="px-4 py-3 bg-sky-50 border border-sky-200 rounded-xl">
          ...
          <div className="flex gap-3 pt-2">
            <button
              ...
              className="py-3 px-4 bg-rose-50 text-rose-600 rounded-xl font-bold hover:bg-rose-100 transition-colors"
            >
              삭제
            </button>
            <button
            ...
            <button
              type="submit"
              className="flex-1 py-3 px-4 bg-gradient-to-r from-sky-500 to-blue-600 text-white rounded-xl font-bold shadow-lg shadow-sky-100 hover:shadow-xl transition-all"
            >
              수정하기
            </button>
          </div>
